...
namespace Benita
{
    ...
    internal static class FactoryClass
    {
        private static readonly Dictionary<string, Type> FunctionMappings = new()
        {
            ...
            { "array_contains", typeof(ArrayManagement) },
            { "array_index_of", typeof(ArrayManagement) },
            { "array_reverse", typeof(ArrayManagement) },
            { "array_clear", typeof(ArrayManagement) },
            { "array_insert", typeof(ArrayManagement) },
            { "array_slice", typeof(ArrayManagement) },
            { "array_concat", typeof(ArrayManagement) },
            { "array_sort", typeof(ArrayManagement) },
